        ...
        <div className="connectors-wrapper" id="connectors">
            ...
            <div className="row certified-row-wrapper">
                <div className="col s12 m4">
                    <a
                        href="https://preview.search-guard.com/docs/latest/elasticsearch-alerting-actions-email"
                        target="_blank"
                ...
                <div className="col s12 m4">
                    <a
                        href="https://preview.search-guard.com/docs/latest/elasticsearch-alerting-actions-slack"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="certified-col-img"
                    >
                ...
                <div className="col s12 m4">
                    <a
                        href="https://preview.search-guard.com/docs/latest/elasticsearch-alerting-actions-pagerduty"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="certified-col-img"
                    >
            ...
            <div className="row">
                <div className="col s12 m4">
                    <a
                        href="https://preview.search-guard.com/docs/latest/elasticsearch-alerting-actions-jira"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="certified-col-img"
                    >
                ...
                <div className="col s12 m4">
                    <a
                        href="https://preview.search-guard.com/docs/latest/elasticsearch-alerting-actions-webhook"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="certified-col-img"
                    >
                ...
                <div className="col s12 m4">
                    <a
                        href="https://preview.search-guard.com/docs/latest/elasticsearch-alerting-actions-index"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="certified-col-img"
                    >
