        ...
        <PageWrapper>
            ...
            <div className="row pressarticle-wrapper">
                ...
                <div className="col s12 l8">
                    <div className="pressarticle-text">
                        <b>Berlin, 06/29/2020. floragunn GmbH, manufacturer of the security plug-in Search Guard, based
                            in Berlin, is strengthening
                            its business activities in the German-speaking market. Software resellers and distributors
                        ...
                        floragunn, manufacturer of the security plug-in Search Guard, is intensifying its activities on
                        the European home market DACH.
                        Thomas Mahler,a graduate engineer for electrical engineering, is the companies new sales contact
                        for software resellers,
                        distributors and business customers. Moving forward there will be additional growth in
                        international sales and OEM partners.

                        <br/><br/>
                        With over 20 years of professional experience in senior management positions at Gemalto, the
                        Thales Group, Canon, Océ,
                        TA Triumph-Adler and many others, Thomas Mahler knows how software resellers and distributors
                        benefit from sales
                        with Search Guard: "Exponentially growing data volumes are rapidly driving up management and
                        security costs.
                        ...
                        to be protected
                        and not on the number of nodes in the clusters. In both the Enterprise and the Compliance
                        Edition, the manufacturer
                        provides the common auto-renewal model. Customers thus have the option of deciding the term of
                        their license themselves.
                        "The Search Guard sales structure is based on the reseller concept. If the customer decides to
                        extend the license,
                        ...
                        for the user, such as integration of Active Directory/LDAP, JSON webtokens, SAML and Single Sign
                        On.
                        The Compliance Edition helps to meet the requirements of the DSGVO and enables, among other
                        things,
