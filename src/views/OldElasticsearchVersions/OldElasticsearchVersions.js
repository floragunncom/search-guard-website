        ...
        "
            ...
            <div className="alerting-wrapper">
                ...
                <div className="row alerting">
                    <h2 className="alerting-headline">Search Guard is still available for older and outdated
                        Elasticsearch Versions</h2>
                    ...
                    <div className="alerting-section">
                        <div className="alerting-content">
                            ...
                            <div className="alerting-content-text">
                                ...
                                Elasticsearch’s older versions have a list of well known issues that are fixed in later
                                versions as well as significant feature enhancements.
                                However many organizations implemented Elasticsearch sometime ago and find they don’t
                                have the skills or knowledge to unpick the integrations built at the time.
                                <br/><br/>
                                As a result some organizations find that attempting to move forward can be very resource
                                intensive and time consuming.
                                So some organizations prefer to stay on the older version of Elasticsearch but, of
                                course, this can carry significant risks in particular with Security.
                    ...
                    <div className="alerting-section">
                        <div className="alerting-content">
                            ...
                            <div className="alerting-content-text">
                                ...
                                Search guard still provides versions of our Security plugins for Elasticsearch 6 as well
                                as version 5 and, yes, even version 2.
                                By implementing Search Guard you can stabilize your security particularly with
                                Encryption in motion,
                                Authn and Authz. We can also provide guidance on how to migrate to more current versions
                                of Elasticsearch (Paid service).
                            </div>
                        </div>
                    </div>
                </div>
