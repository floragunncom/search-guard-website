...
const Presentations = () => {
  const presentations = [
    {
      image: "https://docs.search-guard.com/latest/search_guard_installation.png",
      ...
      link: 'https://docs.search-guard.com/resources/presentations/01_SG_Documents_installation.pdf'
    },
    {
      image: "https://docs.search-guard.com/latest/search_guard_architecture_request_flow.png",
      ...
      link: 'https://docs.search-guard.com/resources/presentations/02_SG_Documents_architecture_request_flow.pdf'
    },
    {
      image: "https://docs.search-guard.com/latest/search_guard_configuration_basics.png",
      ...
      link: 'https://docs.search-guard.com/resources/presentations/03_SG_Documents_configuration_basics.pdf'
    },
    {
      image: "https://docs.search-guard.com/latest/elasticsearch_active_directory_ldap.png",
      ...
      link: 'https://docs.search-guard.com/resources/presentations/04_SG_Documents_active_directory_ldap.pdf'
    },
    {
      image: "https://docs.search-guard.com/latest/elasticsearch_json_web_tokens.png",
      headline: 'JSON web tokens',
      text:
        'How to use JSON web tokens for Elasticsearch single sign on authentication.',
      link: 'https://docs.search-guard.com/resources/presentations/05_SG_Documents_json_web_tokens.pdf'
    },
    {
      image: "https://docs.search-guard.com/latest/elasticsearch_auditlogging.png",
      ...
      link: 'https://docs.search-guard.com/resources/presentations/06_SG_Documents_auditlogging.pdf'
    },
    {
      image: "https://docs.search-guard.com/latest/elasticsearch_search_guard_document_field_level_security.png",
      ...
      link: 'https://docs.search-guard.com/resources/presentations/07_SG_Documents_document_and_field_level_security.pdf'
    },
    {
      ...
      link: 'https://docs.search-guard.com/resources/presentations/Zero_Trusted_Networks.pdf'
    },
  ];
