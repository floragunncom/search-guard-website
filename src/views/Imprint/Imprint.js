  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          name="description"
          content="Company information and liability for content and links."
        />
      </Helmet>
      <NavBar />
      <Title
        ...
        <div className="col s12 l8 offset-l2">
          <div className="imprint-wrapper">
            ...
            <div className="imprint-text">
              ...
              können wir jedoch keine Gewähr übernehmen. Als Diensteanbieter sind wir gemäß § 7 Abs.1 TMG für eigene Inhalte auf
